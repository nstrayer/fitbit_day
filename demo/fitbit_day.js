...
},{"d3":3}],7:[function(require,module,exports){
'use strict';
  ...
  _createClass(TagViz, [{
    ...
    value: function draw(tags) {
      ...
      var tagColors = [].concat(_toConsumableArray(new Set(tags.map(function (tag) {
        ...
        return Object.assign(colorObj, _defineProperty({}, unique, _this.colorScale[i]));
      }, {});

      // JOIN data to our tags holder
      var tagBars = this.tagG.selectAll('.tag_bar').data(tags, function (d) {
        return d.start;
      });
      ...
      tagBars.transition(this.trans).style('fill', function (d) {
